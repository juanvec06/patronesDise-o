...
public class Main {
    public static void main(String[] args) {
        // ------------------ COMMAND ------------------
//        System.out.println("\n--- Command Pattern ---");
//        Project project = new Project("Inventory System","Inventory management system",8);
...
//        invoker.executeCommands();
        ...
        Project project2 = new Project("Academic System","Acdemic project manager",9);
...
//        ----------- PROXY ------------------
        System.out.println("\n--- Proxy Pattern ---");
        ProjectRepositoryProxy repo = new ProjectRepositoryProxy("admin", "1234");
